...
pub struct RacetrackParser {
    char_mapping: HashMap<char, Field>,
}

impl RacetrackParser {
    pub fn new() -> RacetrackParser {
        RacetrackParser { char_mapping: HashMap::from([
            ('S', Field::Start),
            ('E', Field::End),
            ('.', Field::Empty),
            ('#', Field::Wall),
...
impl Parse<Table<Field>> for RacetrackParser {
