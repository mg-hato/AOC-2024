#[cfg(test)]
pub mod suite {
    use crate::{answer::DisplayableAnswer, day_14::{make_pipeline, models::XY, safety_factor_calculator::SafetyFactorCalculator}, solver::Solve, testing::get_verified_result_ok};
    ...
    pub fn test_whole_flow_part_1_example() {
        ...
        let solver = SafetyFactorCalculator::new(100, XY { x: 11, y: 7 }).unwrap();
